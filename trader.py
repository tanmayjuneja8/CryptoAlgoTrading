...
class LongShortTrader:
    def __init__(
        self, symbol, bar_length, return_thresh, volume_thresh, units, position=0
    ):
    ...
    def stream_candles(self, msg):
        ...
        # print out
        print(".")  # just print something to get a feedback (everything OK)
...
if (
    __name__ == "__main__"
):  # only if we run trader.py as a script, please do the following:
    ...
    secret_key_testnet = (
        "rhleExukPgksITlkpqZGpBPVuF9qfGRGOHDwBmlg42aKMZznNmT0ikJfEZwTrEVM"
    )

    client = Client(
        api_key=api_key_testnet, api_secret=secret_key_testnet, tld="com", testnet=True
    )
